...
INSERT INTO `historiales` (`id`, `cantidad`, `id_bodega_origen`, `id_bodega_destino`, `id_inventario`, `created_by`, `updated_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT INTO `usuarios` (`id`, `nombre`, `email`, `email_verifed_at`, `estado`, `created_by`, `updated_by`, `foto`, `password`, `created_at`, `updated_at`, `deleted_at`) VALUES
